              ...
              <Link href={`/projects/${project.slug}`} className="group block">
                <div className="relative aspect-[4/3] overflow-hidden rounded-xl">
                  ...
                  <div
                    ...
                    style={{
                      backgroundImage: `
                        ...
                        linear-gradient(0deg, rgba(201,169,110,0.1) 1px, transparent 1px)
                      `,
                  ...
                  <div className="absolute bottom-0 inset-x-0 p-4">
                    ...
                    <h3 className="mt-1 text-lg font-bold text-white transition-colors group-hover:text-gold-400">
